...
- **Probabilistic**: If it says the element IS in the set, it might be (false positive possible)
- **Immutable**: Elements can be added but not removed from a standard Bloom filter
